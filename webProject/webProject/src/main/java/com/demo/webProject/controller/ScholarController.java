package com.demo.webProject.controller;

import java.util.List;
import com.demo.webProject.model.ScholarModel;
import com.demo.webProject.service.ScholarService;
...
public class ScholarController {	
		...
		@ResponseBody
		public List<ScholarModel> getAllScholars() {
		...
		public String postAddScholar(@RequestBody ScholarModel sch) {
			return sS.postAddScholar(sch);
		}
		
		@PostMapping("updateScholar")
		public String postUpdateScholar(@RequestBody ScholarModel sch) {
